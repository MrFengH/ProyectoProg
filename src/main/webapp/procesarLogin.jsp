...
<body>
    ...
    <%--
        Valida el email/password recibidos del formulario de login.html
        contra el procedure validar_login. Si coincide, guarda el
        cliente_id y el nombre en sesion para usarlos mas adelante
    ...
    <%
        ...
        try {
            ...
            // resultado = 1 significa credenciales válidas
            if (resultado == 1) {
            ...
            // Siempre cerrar el CallableStatement y la conexion, haya
    ...
    %>
    <!-- Contenido principal: resultado del intento de inicio de sesion -->
